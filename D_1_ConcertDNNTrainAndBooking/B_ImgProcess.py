...
for ii in Eng:
    if not os.path.exists(os.path.join(savePath,ii)):
        os.mkdir(os.path.join(savePath,ii))
...
## 60
## gooe Case 11 12
## 13 Case 1   ,17 but not ok ,1 2 6 7 9 10 11 12 17 20 21 27 28 32 35 36 39 41 42 43 47 48 50 51 53 61 64  // 11
## 14 Case 2 ,4 14 22 29 30 31 33 34 49                                                                     // 31
## 15,16 Case 3 ,15 16 23 38 56 57 59 62 63 76 78 79 87 95
## 18,19 ok Case
## 19 GG
...
for ii in range(50,70):
    ...
    # The path of the figure       
        filePath = os.path.join(oriPath,fileName) 
        ...
        for ii,ff in enumerate(Result):
            ...
            test1.save(os.path.join(savePath,saveName + '_' + str(ii) + '.jpg'))
